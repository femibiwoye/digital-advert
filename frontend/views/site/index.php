        ...
        <div class="row justify-content-center align-items-center">
                ...
                <div class="hero-img-group">
                    ...
                    <div class="abs-img img-2" data-aos="fade-left" data-aos-duration="400" data-aos-once="true"
                        ...
                        <div class="image-card card-yellow">
                            ...
                            <p>See what’s happening with your contents on social media!</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-7 order-lg-1" data-aos="fade-right" data-aos-duration="500" data-aos-once="true">
                <div class="hero-content py--50">
                    <h1 class="title">Optimize Your Marketing Campaigns</h1>
                    <h3 class="sub-title">Get thousands of persons to refer people to your
                        content, store, product, service.</h3>
                    <p> Morerave is Nigeria’s No. 1 tool to 10x your sales by capturing
                        more leads and enhancing engagement via social and peer-2-peer
                        referrals. </p>
                    <div class="hero-btn">
                        <a href="<?=Yii::$app->params['androidUrl']?>" class="btn--primary hvr-bounce-to-left">Optimize your Marketing Campaign Here</a>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-12 text-center order-lg-1" data-aos="fade-right" data-aos-duration="500" data-aos-once="true">
                <div class="content-text section-title pr--25">
                    <h2 class="title">Made for Businesses who want MORE </h2>
                    <h4 class="title">More SALES | More ENGAGEMENT | More COMMUNITY </h4>
                    <p>
                        Automate the distribution of your campaign with up to 10,000 Organic, Real and Active Social Media Users who
                        will now belong to your community, as well as promote your marketing content within their personal
                        communities.
                    </p>
                    <p>
                        Raise your lead Generation game by 1000%
                    </p>
                    <div class="content-btn  d-flex justify-content-center">
                        <a href="<?=Yii::$app->params['androidUrl']?>" class="btn--secondary hvr-bounce-to-left">Optimize your Marketing Campaigns </a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="feature-section section-padding">
    <div class="shape-1" data-aos="fade-left" data-aos-duration="400" data-aos-once="true">
        <img src="image/custom/topBG.png" alt="">
    </div>
    <div class="shape-2">
...
<!--                                    <img src="image/png/icon-layout-red.png" alt="">-->
<!--                                </div>-->
<!--                                <div class="card-text">-->
...
<!--                                    <img src="image/png/icon-sidebar-yellow.png" alt="">-->
<!--                                </div>-->
<!--                                <div class="card-text">-->
...
<!--                                    <img src="image/png/icon-brookmark-blue.png" alt="">-->
<!--                                </div>-->
<!--                                <div class="card-text">-->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-xl-6">
                    <div class="section-title text-center">
                        <h2 class="title">Re-focus your marketing content to getting amazing results
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb--30">
                    <div class="testimonial-card">
                        <p class="review-text">Download the Morerave App and
                            Register as a Business Owner and
                            “Start a Campaign”. </p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 mb--30">
                    <div class="testimonial-card">
                        <p class="review-text">Upload your campaign with the
                            necessary links to the product, service,
                            or business you want to promote </p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 mb--30">
                    <div class="testimonial-card">
                        <p class="review-text">All the 8797+ people on the Morerave
                            App (the number keeps growing), will
                            share your campaign for a token </p>
                    </div>
                </div><div class="col-md-12  mb--30">
                    <div class="testimonial-card">
                        <p class="review-text">The only thing you need to do is to prepare for an avalanche of offers </p>
                    </div>
                </div>

                <div class="content-btn">
                    <a href="landing-1.html#" class="btn--primary hvr-bounce-to-left">Get More Traffic</a>
                </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 order-lg-2  col-md-9 col-sm-10">
                <div class="content-img-group content-img-group-1 position-relative ">
                    <div class="img-1" data-aos="fade-down" data-aos-duration="400" data-aos-once="true">
                        ...
                        <img src="image/custom/user.png" alt="">
                    </div>
                    <div class="abs-img img-2" data-aos="fade-right" data-aos-duration="400" data-aos-once="true"
                        ...
                        <div class="image-card-2 card-yellow">
                            ...
                            <div class="card-text">
                                <span class="date">New post alert</span>
                                <p>Your post has been shared 1635
                                    times in the last 45 minutes.
                                    Engage with your tribe</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 order-lg-1" data-aos="fade-right" data-aos-duration="500" data-aos-once="true">
                <div class="content-text section-title pr--25">
                    <h2 class="title">Take advantage of more than a
                        thousand micro-influences and
                        leverage their circle of influence.</h2>
                    <p> Imagine that for every product or service you offer, you have
                        thousands of people that are ready to tell everyone they know
                        about what you do.
                         </p>
                    <p>
                        Even if one can reach 1 million persons, imagine how many
                        persons one million people can reach?
                    </p>
                    <div class="content-btn">
            ...
            <div class="col-lg-7" data-aos="fade-left" data-aos-duration="500" data-aos-once="true">
                <div class="content-text pl-lg--50">
                    <div class="section-title">
                        ...
                        <p class="pr-lg--45">One Platform with multiple media visibility and an opportunity for
                            everyone to grow and succeed </p>
                    ...
                    <div class="widgets-wrapper mt--35">
                        <div class="content-widget mb--15">
                            <div class="widget-icon red">
                                <img src="image/png/icon-cards-red.png" alt="">
                            </div>
                            <div class="widget-text">
                                <h3 class="title">Clients</h3>
                                <span class="sub-title">Individuals, SME, MSME  </span>
                            </div>
                        </div>
                        <div class="content-widget mb--15">
                            <div class="widget-icon blue">
                                <img src="image/png/icon-mobile-blue.png" alt="">
                            </div>
                            <div class="widget-text">
                                <h3 class="title">Mobile App</h3>
                                <span class="sub-title"> Android and IOS</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<!--            <div class="col-lg-7 col-xl-6">-->
<!--                <div class="section-title text-center">-->
<!--                    <h2 class="title">Users are <br class="d-none d-md-block"/> loving moreRave</h2>-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="row justify-content-center">-->
...
<!--                            <h3 class="name">Pamilerin Omo iyaologi</h3>-->
<!--                            <p class="company">CEO at Creativex</p>-->
<!--                        </div>-->
<!--                        <a href="landing-1.html#" class="review-media">-->
<!--                            <i class="fab fa-twitter"></i>-->
<!--                        </a>-->
<!--                    </div>-->
<!--                    <p class="review-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. <a-->
<!--                                href="landing-1.html#" class="secondary-text">@LoremIpsum</a> is my solution…</p>-->
<!--                </div>-->
<!--            </div>-->
<!--            <div class="col-md-6 col-lg-4 mb--30">-->
<!--                <div class="testimonial-card">-->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7 col-xl-6">
                <div class="section-title text-center">
                    ...
                    <p> Get up to 10,000 visits for your
                        Contents on YouTube | Music Store on Spotify, Apple | E-Commerce
                        store | Instagram Page, Website, WhatsApp Business | Online Classes
                        All in 24 Hours or We’ll return your money and work for you for 30 days free</p>
                </div>
                <div class="btns">
                    <ul>
                        <li><a href="#"> <img src="image/custom/play-button.png"> </a></li>
                        <li><a href="#"> <img src="image/custom/apple-button.png"> </a></li>
                    </ul>
                </div>
            </div>
        </div>
