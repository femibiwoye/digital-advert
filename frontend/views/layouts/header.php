...
<header class="site-header bg--conflower-blue sticky-header">
    <div class="container-fluid pr-lg--30 pl-lg--30">
        <nav class="navbar site-navbar offcanvas-active navbar-expand-lg navbar-light">
            <!-- Brand Logo-->
            <div class="brand-logo"><a href="<?=Yii::$app->homeUrl ?>"><img src="image/custom/moreRave-blue-logo.svg" alt=""
                                                              width="150"></a></div>
            <div class="collapse navbar-collapse" id="mobile-menu">
                <div class="navbar-nav ml-lg-auto mr--10">
                    <ul class="navbar-nav main-menu">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="<?=Url::to(['/site/about'])?>" aria-haspopup="true" aria-expanded="false">About
                                Us</a>
            ...
            <div class="header-btns ml-auto ml-lg-0"><a
                        class="btn btn--primary btn-header hvr-bounce-to-left myLinkToTop" href="#">Download App</a>
            </div>
